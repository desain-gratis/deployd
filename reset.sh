...
clickhouse-client -h clickhouse-darurat --password default -q 'truncate database IF EXISTS "deployd-1"'
clickhouse-client -h clickhouse-darurat --password default -q 'truncate database IF EXISTS "deployd-2"'
clickhouse-client -h clickhouse-darurat --password default -q 'truncate database IF EXISTS "deployd-3"'
